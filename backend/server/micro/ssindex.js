...
const server = https.createServer(app); // Create an HTTP server with Express   // s for live server
...
//   // Just send a dummy slot to verify server is alive and responding
//   res.json({
//     user_selected_date: new Date().toISOString().split('T')[0], // today date
//     user_selected_time: '10:00:00'
//   });
// });
